...
def latex_configure() -> None:
    # plt.rcParams["font.sans-serif"].insert(0, "Avenir LT Std")
    # plt.rcParams["font.serif"].insert(0, "Libertinus Serif")
    plt.rcParams["font.family"] = "serif"

    mpl.rcParams["text.usetex"] = True
    mpl.rcParams["mathtext.fontset"] = "custom"
    mpl.rcParams["text.latex.preamble"] = "\\usepackage{libertine,libertinust1math}"
...
if __name__ == "__main__":
    ...
    # fnos_m.train()
    # fnos_m.plot_model_one_masks_all()
    # input("done")
    # fnos_m.train()
    ...
    # cnos_m.train()
    # cnos_m.plot_models_all_mask_one()
    # cnos_m.plot_model_one_masks_all()
    # cnos_m.plot_models_all_mask_one()
